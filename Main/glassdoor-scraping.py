...
#         print(f"\n--- Glassdoor Rating for {company_name} ---")
#         print(f"Average Rating: {rating}")
#         print("\n--- User Reviews ---")
        
#         # Locate the review elements, skipping those in the experience container
#         review_elements = driver.find_elements(By.CSS_SELECTOR, 'li div[data-test="review-details-container"]')
        
#         review_count = 0
#         for review_element in review_elements:
#             # Check if the review element is inside the experience container and skip it if so
#             try:
#                 experience_container = review_element.find_element(By.XPATH, './ancestor::div[contains(@class, "review-details_experienceContainer__2W06X")]')
#                 if experience_container:
#                     continue  # Skip this review if it is within the experience container
#             except:
#                 # Proceed if no ancestor with the specific class is found
#                 pass
            
#             # Extract and format review details
...
#             review_count += 1
#             # Stop after extracting 5 valid reviews
#             if review_count >= 5:
#                 break
...
# # Example usage:
# get_glassdoor_rating_and_reviews("Oracle")
